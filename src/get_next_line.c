...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/28 13:56:44 by idamoutto         #+#    #+#             */
/*   Updated: 2021/01/28 13:56:48 by idamoutto        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_free_buff(char **buff, t_param *param)
{
	if (param->erreur == 2 && *buff)
	{
		free(*buff);
		return (1);
	}
